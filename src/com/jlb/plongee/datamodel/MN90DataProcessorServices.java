...
public class MN90DataProcessorServices extends DataProcessorServices {
	...
	public MN90DataProcessorServices(String databasePath, ILogger logger) {
		super(logger);
		try {
			mDatabaseServices = new DatabaseServiceSQLite(databasePath);
		} catch (SQLException | ClassNotFoundException | IOException e) {
			mLogger.error(this, "Erreur lors de la connexion a la base de donnees " + databasePath, e);
		}
	}
	...
	protected Entity createEntity(String className, ResultSet rs) throws SQLException {
		Entity entity = null;
		mLogger.debug(this, "Creation de l'objet de type " + className);
		if (className.equals(Plongeur.class.getName())) {
			...
			mLogger.info(this, "Le type d'entite " + className + " n'est pas pris en charge !!! ");
		}
		return entity;
	}
